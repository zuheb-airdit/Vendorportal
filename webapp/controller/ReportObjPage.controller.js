sap.ui.define([
    ...
    function (Controller, formatter, UIComponent, JSONModel, MessageBox, Fragment) {
        ...
        return Controller.extend("com.air.vp.lnchpage.controller.ReportObjPage", {
            formatter: formatter,
            onInit: function () {
                var oRouter = UIComponent.getRouterFor(this);
                let oModel = this.getOwnerComponent().getModel("registration-manage");
                this.getView().setModel(oModel);
                this.getOwnerComponent().getRouter().getRoute("ReportObjPage").attachPatternMatched(this.onObjectMatched, this);
